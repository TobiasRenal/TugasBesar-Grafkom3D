...
var composer1, effect, effect2, effect3, effect4;
composer1 = new THREE.EffectComposer(renderer);
composer1.addPass(new THREE.RenderPass(scene, cam));
