...
var particleMaterial = new THREE.ParticleBasicMaterial({ color: 0xeeeeee, map: particleTexture, size: 10, transparent: true, blending: THREE.AdditiveBlending, fog: false });
