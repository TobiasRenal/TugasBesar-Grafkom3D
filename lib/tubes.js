...
loaderClown.load('model/clown_fish/scene.gltf', function (ikanBadut) {
    ...
    taimlainBadut.to(ikan.rotation, { x: -1.6, duration: 3, delay: -4});
});
...
loaderMantaRay.load('model/manta ray/scene.gltf', function (ikanMantaRay) {
    ...
    taimlainMantaRay.to(MantaRay.rotation, {z: 3.2, duration: 3, delay: 5});
    taimlainMantaRay.to(MantaRay.position, {z: 2000, duration: 6});
    taimlainMantaRay.to(MantaRay.rotation, {z: 6.0, duration: 3, delay: 5});
    taimlainMantaRay.to(MantaRay.position, {z: -2500, duration: 3, delay: 5});
});
...
loaderTurtle.load('model/model_52_-_kemps_ridley_sea_turtle_no_id/scene.gltf', function (ikanTurtle) {
    ...
    taimlainTurtle.to(Turtle.position, { z: -2500, duration: 6 });
    taimlainTurtle.to(Turtle.rotation, { z: 3.2, duration: 6 , delay: -5});
    taimlainTurtle.to(Turtle.position, { z: 2500, duration: 10, delay: -2});
    taimlainTurtle.to(Turtle.rotation, { z: 5.9, duration: 3 , delay: -5});
    taimlainTurtle.to(Turtle.position, { z: -2250, duration: 7.5, delay: -2});
