...
cam.lookAt(new THREE.Vector3(-1500, 500, 3500));
...
var particleMaterial = new THREE.ParticleBasicMaterial({ color: 0xeeeeee, map: particleTexture, size: 15, transparent: true, blending: THREE.AdditiveBlending, fog: false });
...
light.position.set(2000, 4500, -2000);
...
circle.position.set(2000, 5200, -2000)
...
loaderClown.load('model/clown_fish/scene.gltf', function (ikanBadut) {
    ...
    let taimlainBadut = gsap.timeline({ repeat: -1, smoothChildTiming: false });
    taimlainBadut.to(ikan.position, { z: -1000, duration: 3 });
    taimlainBadut.to(ikan.rotation, { z: -1.6, duration: 3, delay: -2 });
    taimlainBadut.to(ikan.position, { x: 1000, duration: 3, delay: -2});
    taimlainBadut.to(ikan.rotation, { z: -3.4, duration: 3, delay: -2 });
    taimlainBadut.to(ikan.position, { z: 0, duration: 3, delay: -2 });
    taimlainBadut.to(ikan.rotation, { z: -4.9, duration: 3, delay: -2 });
    taimlainBadut.to(ikan.position, { x: 0, duration: 3, delay: -2 });
    taimlainBadut.to(ikan.rotation, { z: -6.3, duration: 3, delay: -2 });
...
loaderMantaRay.load('model/manta ray/scene.gltf', function (ikanMantaRay) {
    ...
    let taimlainMantaRay = gsap.timeline({ repeat: -1, smoothChildTiming: false });
    taimlainMantaRay.to(MantaRay.position, { z: -2000, duration: 6 });
    taimlainMantaRay.to(MantaRay.rotation, { z: 1.6, duration: 3, delay: -2 });
    taimlainMantaRay.to(MantaRay.position, { x: -2000, duration: 8, delay: -3 });
    taimlainMantaRay.to(MantaRay.rotation, { z: 4.3, duration: 3, delay: -2 });
    taimlainMantaRay.to(MantaRay.position, { z: 0, duration: 8, delay: -3 });
    taimlainMantaRay.to(MantaRay.position, { x: 2000, duration: 8, delay: -8 });
    taimlainMantaRay.to(MantaRay.rotation, { z: 6.3, duration: 3, delay: -3 });
    MantaRay.traverse(n => {
        if (n.isMesh) {
            n.castShadow = true;
            n.receiveShadow = true;
...
loaderTurtle.load('model/model_52_-_kemps_ridley_sea_turtle_no_id/scene.gltf', function (ikanTurtle) {
    ...
    let taimlainTurtle = gsap.timeline({ repeat: -1, smoothChildTiming: false });
    taimlainTurtle.to(Turtle.position, { z: -2500, duration: 4 });
    taimlainTurtle.to(Turtle.rotation, { z: 1.6, duration: 2, delay: -2 });
    taimlainTurtle.to(Turtle.position, { x: -2500, duration: 10, delay: -2 });
    taimlainTurtle.to(Turtle.rotation, { z: 4.2, duration: 3, delay: -2 });
    taimlainTurtle.to(Turtle.position, { z: 500, duration: 14, delay: -2 });
    taimlainTurtle.to(Turtle.position, { x: 2250, duration: 14, delay: -14 });
    taimlainTurtle.to(Turtle.rotation, { z: 6.4, duration: 3, delay: -2 });
...
loaderOctopus.load('model/octopus/scene.gltf', function (ikanOctopus) {
    ...
    scene.add(Octopus);
    taimlaingurita = gsap.timeline({ repeat: -1, smoothChildTiming: false });
